...
{
    public function testeGetMaiorValorCresc()
    {
        // Arrange - Given
    ...
    public function testeGetMaiorValorDesc()
    {
        // Arrange - Given
        $leilao = new Leilao('Fiat 147 0KM');
    ...
    public function testeGetMenorValorDesc()
    {
        // Arrange - Given
        $leilao = new Leilao('Fiat 147 0KM');
    ...
    public function testeGetMenorValorCresc()
    {
        // Arrange - Given
        $leilao = new Leilao('Fiat 147 0KM');
